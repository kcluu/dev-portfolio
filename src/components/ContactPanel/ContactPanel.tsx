...
const EMAIL = 'nora.vance@example.com'
...
export const ContactPanel = () => {
  return (
    <section className="panel">
      ...
      <p className="lede">
        I'm always happy to chat about new roles, collaborations, or your favorite tea. The fastest way to reach me
        is email.
      </p>
